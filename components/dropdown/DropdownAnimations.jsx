...
function DropdownAnimations() {
    ...
    const {setIsLoading,setAnimationData,selectedCountry,setError,setSelectedCountry,searchTerm, setSearchTerm} =useAnimation()
    ...
    useEffect(() => {
        const fetchAnimation = async () => {
          setIsLoading(true)
          try {
            let url = `${BASE_URL}/api/animations?populate=*`
            if (selectedCountry !== "No Country Selected"){
                url = `${BASE_URL}/api/animations?filters[country][name][$eq]=${selectedCountry}&populate=*`
            }
            console.log("urlAnimation:",url);
            
            const response = await axios.get(url)
            console.log("fetched Animation data---",response.data);
        ...
        fetchAnimation()
      },[selectedCountry,setAnimationData,setIsLoading,setError])
