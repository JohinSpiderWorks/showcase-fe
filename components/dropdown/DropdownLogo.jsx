...
function DropdownLogo() {
  ...
  //console.log("Country selectedCountry", selectedCountry);
  //console.log("Country setSelectedCountry", setSelectedCountry);
  ...
  useEffect(() => {
    const fetchLogo = async () => {
      ...
      setError(null);
      try {
        let url = `${BASE_URL}/api/logos?populate=*`;
        if (selectedCountry !== "No Country Selected") {
          url = `${BASE_URL}/api/logos?filters[country][name][$eq]=${selectedCountry}&populate=*`;
          console.log("url for logo",url);
        }
        // if (searchTerm) {
        //   url += `&filters[name][$contains]=${searchTerm}`;
        // }
        
        const response = await axios.get(url);
        console.log("response logo:", response.data);
        ...
        setIsLoading(false);
        console.log("is notloading dropdown",isLoading);
      }
    };
    fetchLogo();
  }, [setLogoData, setIsLoading, setError,selectedCountry]);
